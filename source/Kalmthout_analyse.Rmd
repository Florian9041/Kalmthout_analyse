...
# fysische variabelen
gemiddeldes <- data %>%
  filter(AquaComponent %in% c("pH_veld", "T_veld", "O2verz", "O2_veld", "EGV25_veld", "sal_veld", "alkaliniteit", "SD_veld", "ZS.105")) %>% group_by(CODE, AquaComponent) %>% summarise(gemiddelde = mean(ResultCalc))
...
BOD_90p <- 6 # BVR
COD_90p <- 30 # BVR
T.P <- 0.04 # mg P/L - T'jollyn et al. 2009, totaalfosfor: naar Denys et al. (2005), Heinis & Evers (2007); omzetting KRW en N2000-typen: Bal et al. (2001), Fellinger et al. (2004)
