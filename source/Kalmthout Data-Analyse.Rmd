...
plots_pH <- generate_multiple_plots_minmax(reeks_2020, "pH_veld", "<2020", grenswaarden_pH, "pH")
...
plots_Cl2020 <- generate_multiple_plots(reeks_2020, "Cl", "<2020", y_label = "Chloride (mg/l)", watertype_thresholds = grenswaarden_Cl)
...
plots_pH <- generate_multiple_plots(reeks_2022_2024, "pH_veld", grenswaarden_pH, "pH")
walk2(plots_pH, names(plots_pH),
      ~ggsave(filename = paste0("./exports/pH/", .y, "_", "pH", ".png"), plot = .x, width = 10, height = 6))
```
