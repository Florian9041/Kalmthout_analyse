...
data_KAL_temp <- data_KAL %>%
  mutate(ResultCalc = case_when(
    AquaComponent %in% c("SO4_S", "NH4_N") ~ as.numeric(ResultFormattedNumeric),
    grepl("<", ResultFormatted) ~ as.numeric(gsub("<", "", ResultFormatted)) / 2,
    TRUE ~ as.numeric(gsub(">", "", ResultFormatted))
  ))
